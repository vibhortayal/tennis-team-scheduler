...
.identity-modal{width:min(440px,100%) !important;background:#fff;border:1px solid #e0e8df;border-radius:16px;padding:22px;box-shadow:0 18px 48px rgba(16,32,21,.24)}
