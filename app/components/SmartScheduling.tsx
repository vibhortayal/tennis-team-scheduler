...
<p>
Your group and team come from the player selected in the top-right menu. To schedule on someone else&apos;s behalf, switch the selected player there first.
</p>
</div>
...
<article className="card suggestion-card" key={`${suggestion.opponentId}-${suggestion.date}`}>
