...
type SmartSchedulingProps = {
  ...
  comparisonParticipantKeys: string[];
    ...
    <section className="suggestions-panel">
      ...
      {identity.viewing ? (
        ...
        <>
          ...
          <AvailabilityManager
            availabilitySlots={
              schedulingTab === 'overview' ? comparisonAvailabilitySlots : availabilitySlots
            }
            blockingSlots={schedulingTab === 'overview' ? comparisonBlockingSlots : blockingSlots}
            teamMatches={teamMatches}
            participantStatusMap={participantStatusMap}
            participantKeys={schedulingTab === 'overview' ? comparisonParticipantKeys : []}
